...
const Stats = ({ statsData, variant }) => {
  return (
    <div
      className={`flex flex-wrap justify-center items-stretch gap-6 p-4 max-w-[1200px] w-full mx-auto mb-8 relative z-[10] border-[3px] border-[#d0e5ff] rounded-[24px] shadow-[0_15px_35px_rgba(30,100,200,0.1),0_5px_15px_rgba(0,100,200,0.07)] ${
        variant === "genai"
