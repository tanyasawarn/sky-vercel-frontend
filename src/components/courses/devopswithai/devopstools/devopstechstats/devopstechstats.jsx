...
const TechnologiesSection = () => {
  return (
    <div className="bg-gradient-to-br from-[#f8faff] to-[#f0f5ff] text-center px-4 py-2 rounded-[20px] max-w-[1200px] mx-auto my-8 shadow-[0_6px_15px_rgba(0,0,0,0.08)] max-[480px]:w-[95%]">
